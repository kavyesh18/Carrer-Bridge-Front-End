const fields=[
    ...
    {label:"Company",placeholder:"Enter Company Name", options:['Google', 'Microsoft', 'PayPal', 'Mindtree', 'Accenture', 'S&P Global', 'Capgemini', 'Atlassian',]},
    ...
    {label:"Location",placeholder:"Enter Job Location", options:['Delhi', 'New York', 'San Francisco', 'Hyderabad', 'Berlin', 'Benguluru', 'Sydney', 'Toronto','Chennai','Noida','Pune','Mumbai']},
